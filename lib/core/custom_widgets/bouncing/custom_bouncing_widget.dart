...
class CustomBouncingWidget extends StatefulWidget {
  ...
  /// Scale factor
  ///  < 0 => the bouncing will be reversed and step_pages will grow
  ///    1 => default value
...
class _CustomBouncingWidgetState extends State<CustomBouncingWidget>
  ...
  /// Simple getter on step_pages's child
  Widget get child => widget.child;

  /// Simple getter on step_pages's onPressed callback
  Function()? get onPressed => widget.onPressed;

  /// Simple getter on step_pages's scaleFactor
  double get scaleFactor => widget.scaleFactor;

  /// Simple getter on step_pages's animation duration
  Duration get duration => widget.duration;

  /// Simple getter on step_pages's stayOnBottom boolean
  ...
  /// and pass it to our Transform.scale step_pages
  @override
