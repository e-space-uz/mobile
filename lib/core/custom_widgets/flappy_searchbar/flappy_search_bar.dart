...
class SearchBar<T> extends StatefulWidget {
  ...
  /// Callback returning the step_pages corresponding to a Suggestion item
  ...
  /// Callback returning the step_pages corresponding to an item found
  final Widget Function(T? item, int index) onItemFound;

  /// Callback returning the step_pages corresponding to an Error while searching
